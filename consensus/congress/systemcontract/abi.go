...
var (
	...
	AuxiliaryValidatorContractName = "auxiliaryValidator"
	...
	AuxiliaryValidatorContractAddr = common.HexToAddress("0x000000000000000000000000000000000000F010")
...
func init() {
	...
	tmpABI, _ = abi.JSON(strings.NewReader(AuxiliaryValidatorABI))
	abiMap[AuxiliaryValidatorContractName] = tmpABI
}
